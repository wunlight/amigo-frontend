...
function ProductCard({ name, price, unit, stocks, selectedStock, onIncrement, onDecrement }: ProductCardProps) {
    ...
    <div className="flex flex-col gap-3 p-3 bg-zinc-50 rounded-lg">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="icon" onClick={onIncrement} aria-label="Increase quantity">
